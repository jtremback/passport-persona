...
/**
 * Authenticate request by using persona.org as a trusted secondary authority
    ...
    res.on('end', function() {
      try {
        ...
        if (result.status === 'okay') {
          ...
          console.error('authorization verification filed', result.reason);
